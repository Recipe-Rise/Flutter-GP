...
class UnderstandingScreen extends StatelessWidget {
  const UnderstandingScreen({Key? key}) : super(key: key);
        ...
        return Scaffold(
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                const ProgressIndicatorBar(currentStep: 3, totalSteps: 5),
                ...
                const Text(
                  "Some diets can get boring or repetitive.",
                  style: TextStyle(
                    fontSize: 28,
                    fontWeight: FontWeight.bold,
                  ),
                ...
                const SizedBox(height: 24),
                Text(
                  "Now, let's talk about your goal to ${state.getNextStepDescription()}.",
