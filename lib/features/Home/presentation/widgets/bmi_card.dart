...
class BmiCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final calculatedBmi = AppCubit.get(context).getUserData?.bmi;
    ...
    return BlocConsumer<AppCubit,AppStates>(
      ...
      return Card(
        color: _getCardColor(double.parse(calculatedBmi!)),
        elevation: 4,
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          _getWeightStatus(double.parse(calculatedBmi)),
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => DetailedBmiScreen(
                                  ...
                                  weight: AppCubit.get(context).getUserData!.weight!,
                                  height: AppCubit.get(context).getUserData!.height!,
                                  age: AppCubit.get(context).getUserData!.age!,
                                  gender: AppCubit.get(context).getUserData!.gender!,
                                ),
                              ),
                            );
                          },
                  ...
                  CircularPercentIndicator(
                    radius: 40,
                    lineWidth: 12,
                    percent: double.tryParse(calculatedBmi)! / 40 > 1 ? 1 : double.tryParse(calculatedBmi)! / 40,
                    center: Text(
                      calculatedBmi,
