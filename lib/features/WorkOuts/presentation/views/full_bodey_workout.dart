                                ...
                                onArrowPressed: (){
                                    if(bodyPart == 'back'){
                                      Navigator.of(context).push(
                                          MaterialPageRoute(
                                            builder: (context) {
                                                return const EachBodypartWorkouts(bodyPart: 'back');
                                            },
                                          ),
                                        );
                                    }
                                    if(bodyPart == 'chest'){
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (context) {
                                            return const EachBodypartWorkouts(bodyPart: 'chest');
                                          },
                                        ),
                                      );
                                    }
                                      ...
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (context) {
                                            return const EachBodypartWorkouts(bodyPart: 'lower arms');
                                          },
                                        ),
                                      );
                                    }
                                      ...
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (context) {
                                            return const EachBodypartWorkouts(bodyPart: 'lower legs');
                                          },
                                        ),
                                      );
                                    }
                                      ...
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (context) {
                                            return const EachBodypartWorkouts(bodyPart: 'neck');
                                          },
                                        ),
                                      );
                                    }
                                      ...
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (context) {
                                            return const EachBodypartWorkouts(bodyPart: 'shoulders');
                                          },
                                        ),
                                      );
                                    }
                                      ...
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (context) {
                                            return const EachBodypartWorkouts(bodyPart: 'upper arms');
                                          },
                                        ),
                                      );
                                    }
                                      ...
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (context) {
                                            return const EachBodypartWorkouts(bodyPart: 'upper legs');
                                          },
                                        ),
                                      );
                                    }
                                    ...
                                    //   MaterialPageRoute(
                                    //     builder: (context) {
                                    //         return const EachWorkoutDetails();
                                    //     },
                                    //   ),
                                    // );
                                },
