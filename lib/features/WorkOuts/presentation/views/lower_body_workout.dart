                      ...
                      builder: (context , state){
                        ...
                        if(state is WorkOutBodyPartsSuccessState){
                          final bodyParts = state.bodyParts
                              .where((bodyPart) => bodyPart.toLowerCase() == 'lower legs' || bodyPart.toLowerCase() == 'upper legs').toList();
                              ...
                              return BodyPartCard(
                                ...
                                onArrowPressed: (){
                                  if(bodyPart == 'lower legs'){
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) => const EachBodypartWorkouts(bodyPart: 'lower legs',),
                                      ),
                                    );
                                  }
                                    ...
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) => const EachBodypartWorkouts(bodyPart: 'upper legs',),
                                      ),
                                    );
                                  }
                                },
