                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ListTile(
                            title: const Text("Loss weight and gain muscles"),
                            leading: Radio<String>(
                              value: "Loss weight and gain muscles",
                              groupValue: _selectedFitnessGoal,
                              onChanged: (String? value) {
                                setState(() {
                                  _selectedFitnessGoal = value;
                  ...
                  Center(
                    child: CustomGradientButton(
                      ...
                      onPressed: () {
                        ...
                        cubit.updateWeight(double.parse(_weightController.text));
                        cubit.updateHeight(double.parse(_heightController.text));
                        cubit.updateFitnessGoal(_selectedFitnessGoal!);
                        cubit.updateActivityLevel(_selectedActivityLevel!);
                        ...
                        RegisterCubit.get(context).registerUser(
                          ...
                          weight: cubit.registerData.weight,
                          height: cubit.registerData.height,
